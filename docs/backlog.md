...
|----|------|----------|------|--------|-------|
| REL-01 | Fix GigE discovery on Windows APIPA networks ([#57](https://github.com/VitalyVorobyev/viva-genicam/issues/57)) | P0 | M | done | All eight defects below fixed. **Hardware-confirmed by [#70](https://github.com/VitalyVorobyev/viva-genicam/issues/70)**: discovery, connect and GenApi work against the reporter's JAI on a Windows APIPA link |
...
| SR-05 | Library-owned heartbeat keepalive | P0 | M | planned | Consumers lose CCP after ~3 s idle — **hardware-confirmed via [#70](https://github.com/VitalyVorobyev/viva-genicam/issues/70)/[#72](https://github.com/VitalyVorobyev/viva-genicam/pull/72)**, no longer a prediction. After #72 merges the workspace will carry three app-layer copies (`viva-service`, camctl, studio embedded backend); this task replaces all three |
